...
out_put1 = path+ "/"+ path [13:]+"global-local_90_Circos.txt"                             # output the blast_v2all file >90pid (blast comparison with the whole genome_global repeats)
out_put2 = path+ "/"+ path [13:]+"global-local_95_Circos.txt"                             # output the blast_v2all file >95pid(blast comparison with itself_local repeats)
...
for line in lines1:
                ...
                if line3.startswith('chr'):
                                x = cols[2][:-1]
                                y = float(x)
                                if y >= 90 and ((((int(cols [6])) != (int (cols [8]))) and ((int(cols [7])) != (int (cols [9])))) and (((int(cols [6])) != (int (cols [9]))) and ((int(cols [7])) != (int (cols [8])))) ):
                                                #print ("zm"+cols0 [2])
                                                #print ("zm"+cols1 [2])
                                ...
                                if y >= 95 and ((((int(cols [6])) != (int (cols [8]))) and ((int(cols [7])) != (int (cols [9])))) and (((int(cols [6])) != (int (cols [9]))) and ((int(cols [7])) != (int (cols [8])))) ):
